...
class Jugador_Descalificado (Exception):
  def __init__(self):
    Exception.__init__(
        self, "Un jugador ha sido descalificado. Partida terminada")
...
class Tablero:
  ...
  def hay_tres_en_raya(self):
    ...
    posibles = ["00:01:02", "00:11:22", "10:11:12", "20:21:22",
        "00:10:20", "01:11:21", "02:12:22", "02:11:20"]

    for posibles in posibles:
      coordenadas = posibles.split(":")
      fichas = []  # metemos las fichas de las coordenadas, 3 en total

      for coordenadas in coordenadas:
        fichas.append(
            self.__matriz_celdas[int(coordenadas[0])][int(coordenadas[1])].get_tipo_ficha())
      ...
      if (fichas[0] == fichas[1] and fichas[1] == fichas[2] and fichas[1]!=" "):  # hay 3 en hay_tres_en_raya
        ...
        return True  # devolvemos la ficha ganadoram  
    return False
...
class Partida:
  ...
  def set_ganador(self,ganador):
    return self.__ganador == self.__ganador

  def termina_partida(self):
    return self.__partida_terminada == True
